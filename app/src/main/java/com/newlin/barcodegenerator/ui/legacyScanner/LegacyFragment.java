...
import com.newlin.barcodegenerator.ui.legacyScanner.CameraSource;

public class LegacyFragment extends Fragment {

    private static final String TAG = "OcrCaptureActivity";

    // request code to handle updating play services if needed.
    ...
    private LegacyViewModel dashboardViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_legacy, container, false);
        preview = (CameraSourcePreview) root.findViewById(R.id.preview);
        graphicOverlay = (GraphicOverlay<OcrGraphic>) root.findViewById(R.id.graphicOverlay);
        ...
        /*Snackbar.make(graphicOverlay, "Point camera at screen to generate barcodes.",
